...
- Enforce authenticated account ownership, Bedrock zero-data-retention eligibility, encrypted raw-output retention until report deletion, redacted observability, and fixture-based rollout gates including zero documented-condition candidates without literal cited condition text.
