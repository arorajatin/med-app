...
- Keep profile matching outside the provider. Only an exact, account-local name or alias match without contradictory DOB evidence may resolve automatically.
