...
- [x] 1.1 Complete `add-database-migrations` and provision a disposable Supabase test environment.
- [x] 1.2 Spike and select a request-scoped database identity approach that does not bypass RLS.
- [x] 1.3 Configure production SQLAlchemy persistence with fail-closed environment validation.
- [x] 1.4 Add row-level policies for every user-owned table through migrations.
- [x] 1.5 Add two-user integration tests for read, insert, update, and delete isolation.
