...
- Chat requires one selected profile before a conversation starts.
...
4. Once assignment resolves, the report becomes available in that person's Drive and extraction outputs can publish.
5. A renamed report uses the current display filename consistently across Feed, Drive, and report details.
6. A deleted report disappears from all current views immediately.
